...
#End of Initializ............................
	...
	#Set btn&text(lbl) into layout then set it into browse QLbl:
		...
		layout.addWidget(browseTxtQlabel, 0, Qt.AlignHCenter) 
...
class SettingDialog(QMainWindow):
	...
	#Color Button:
		...
		self.align_color_button.setFixedHeight(int(self.window_height/10))
		self.align_color_button.setFixedWidth(int(self.window_width/4))
		...
		self.align_color_button.setIconSize(QSize(int(self.window_width/4), int(self.window_height/10)))
	...
	#End of Align GroupBox#################################################
		...
		self.btn_align_ok.setMinimumHeight(int(self.window_height/10)) ######################################
