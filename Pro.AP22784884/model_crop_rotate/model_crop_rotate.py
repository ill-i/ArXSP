...
#Initializer:
	...
	#For tabs controller______________________________________________________
		...
		tab_layout_rotate.setSpacing(1)  
		tab_layout_rotate.setContentsMargins(0, 0, 0, 5)  
		...
		tab_layout_crop.setContentsMargins(0, 0, 0, 5)  
	...
	<p style="text-align: justify;"><b>Tool View Settings:</b></p>
		...
		# Setting_text_label.setFixedSize(600, 38)  
		Setting_text_label.setFixedHeight(int(self.model.win_h/30))		
		...
		# self.Setting_button.setFixedSize(400, 70) 
		...
		#layout
		h_layout.addWidget(Setting_text_label, 10)   #stretch=10
