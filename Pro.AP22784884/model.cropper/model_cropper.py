...
#Initializer:
	...
	#For tabs controller______________________________________________________
		...
		main_tabs_label.setMinimumSize(720, 1000)
		...
		tab_text_label.setMinimumSize(720, 100)
		...
		#tab_layout_rotate.setContentsMargins(10, 30, 10, 0)  # Убирает внешние отступы
	...
	#Ok-Cancel buttons:
		...
		rotate_buttons_layout.setContentsMargins(20, 0, 30, 0)
		rotate_buttons_layout.setSpacing(50) ##################

		# 2. Create 2 buttons  ###########################################################
		self.btn_rotate_cancel = QPushButton("Cancel") ###################################
		self.btn_rotate_cancel.setObjectName("cropper_browse_btn") #######################
		self.btn_rotate_cancel.setMinimumHeight(70) ######################################
		...
		self.btn_rotate_ok.setMinimumHeight(70) ######################################
	...
	#Ok-Cancel buttons:
		...
		crop_buttons_layout.setContentsMargins(20, 10, 30, 20)
		crop_buttons_layout.setSpacing(50) ##################

		# 2. Create 2 buttons  #########################################################
		self.btn_crop_cancel = QPushButton("Cancel") ###################################
		self.btn_crop_cancel.setObjectName("cropper_browse_btn") #######################
		self.btn_crop_cancel.setMinimumHeight(70) ######################################
		...
		self.btn_crop_ok.setMinimumHeight(70) ######################################
	...
	#Size of dark label #######################################
		edit_label.setFixedSize(720, 160) ###################
		#######################################################
	...
	#Size of label for the text:
		edit_text_label.setFixedSize(600, 50) ############
		####################################################
	...
	#Button to browse:
		...
		self.edit_button.setFixedSize(400, 70) #############
		######################################################

	#Set btn & text(lbl) into layout then set layout into browse label widget:
		edit_label.setLayout(layout) #######################################
		layout.addWidget(edit_text_label, 10, Qt.AlignHCenter) #############
	...
	#Size of dark label #######################################
		save_label.setFixedSize(720, 160) ###################
		#######################################################
	...
	#Size of label for the text:
		save_text_label.setFixedSize(600, 50) ############
		####################################################
	...
	#Size of dark label #########################################
		Setting_label.setFixedSize(720, 100) ####################
		#########################################################
    ...
    <p style="text-align: justify;"><b>Tool View Settings:</b></p>
		...
		Setting_text_label.setFixedHeight(38)        # Если хотите ограничить высоту
		...
		self.Setting_button.setFixedHeight(70)
		...
		self.Setting_button.setIconSize(QSize(300, 65))
		...
		# Также убираем фиксированную ширину, оставляем только высоту:
		# self.Setting_button.setFixedSize(400, 70)  # УДАЛЕНО
		Empty_button.setFixedHeight(70)
...
class SettingDialog(QMainWindow):
	...
	#Color Button:
		...
		self.rot_hor_color_button.setFixedHeight(60)
		self.rot_hor_color_button.setFixedWidth(80)

		#set icon into color btn:
		script_dir = os.path.dirname(os.path.abspath(__file__))
		icon_path = os.path.join(script_dir, "color_btn.png")
		self.rot_hor_color_button.setIcon(QIcon(icon_path))
		self.rot_hor_color_button.setIconSize(QSize(80, 55))
	...
	#Color Button:
		...
		self.rot_deg_color_button.setFixedHeight(60)
		self.rot_deg_color_button.setFixedWidth(80)

		#set icon into color btn:
		script_dir = os.path.dirname(os.path.abspath(__file__))
		icon_path = os.path.join(script_dir, "color_btn_3.png")
		self.rot_deg_color_button.setIcon(QIcon(icon_path))
		self.rot_deg_color_button.setIconSize(QSize(80, 55))
	...
	#Color Button:
		...
		self.crop_color_button.setFixedHeight(60)
		self.crop_color_button.setFixedWidth(80)

		#set icon into color btn:
		script_dir = os.path.dirname(os.path.abspath(__file__))
		icon_path = os.path.join(script_dir, "color_btn_4.png")
		self.crop_color_button.setIcon(QIcon(icon_path))
		self.crop_color_button.setIconSize(QSize(80, 55))
