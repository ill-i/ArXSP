	...
	def handle_polynom_button_click(self):
		...
		try:
			if best_poly is None:
				print(" best_poly is None. not possible to plot.")
				return
		
			if root is None or extra_poly is None:
				print(" use only best_poly")
				...
				y_extrapolate = extra_poly(x_extrapolate)  # 
